...
_TEXT_GENERATION_MODELS = {
    ...
    "Glm4MoeLiteForCausalLM": ("deepseek_v2", "DeepseekV3ForCausalLM"),
...
_SUBPROCESS_COMMAND = [sys.executable, "-m", "aphrodite.modeling.models.registry"]
...
class _LazyRegisteredModel(_BaseRegisteredModel):
    ...
    def _get_cache_dir() -> Path:
        return Path(envs.APHRODITE_CACHE_ROOT) / "modelinfos"
    ...
    def _save_modelinfo_to_cache(self, mi: _ModelInfo, module_hash: str) -> None:
        ...
        from aphrodite.modeling.model_loader.weight_utils import atomic_writer
    ...
    def _raise_for_unsupported(self, architectures: list[str]):
        ...
        for arch in architectures:
            if arch in _PREVIOUSLY_SUPPORTED_MODELS:
                ...
                raise ValueError(
                    f"Model architecture {arch} was supported in Aphrodite until "
                    f"v{previous_version}, and is not supported anymore. "
                    "Please use an older version of Aphrodite if you want to "
